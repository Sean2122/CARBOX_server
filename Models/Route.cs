...
namespace carbox.Models
{
    public class Route
    {
        ...
        public required string Name { get; set; }  // Route name
        public List<Station> Stations { get; set; } = new List<Station>(); // List of stations in the route
        public required Station ChargingStation { get; set; }  // Charging station (Station 0)
        ...
        public required Dictionary<(int, int), int> travelTimeMatrix { get; set; }
